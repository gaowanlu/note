...
- [17、备忘录模式(Memento 模式)](./xing-wei-mo-shi/memento.md)
- [18、中介者模式(Mediator 模式)](./xing-wei-mo-shi/mediator.md)
- [19、命令模式(Command 模式)](./xing-wei-mo-shi/command.md)
- [20、访问者模式(Visitor 模式)](./xing-wei-mo-shi/visitor.md)
- [21、责任链模式(Chain of Responsibility 模式)](./xing-wei-mo-shi/chain_of_responsibility.md)
- [22、迭代器模式(Iterator 模式)](./xing-wei-mo-shi/iterator.md)
- [23、解释器模式(Interpreter 模式)](./xing-wei-mo-shi/interpreter.md)
