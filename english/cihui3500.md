...
- [ ] `budget [ˈbʌdʒɪt]`
    n./v.预算 【例】a family budget家庭预算

- [ ] `unit [ˈjuːnɪt]`
    n.单元；单位 【例】an army unit一支部队

- [ ] `harm [hɑːm]`
    n./vt.伤害，损伤 Being exposed to sunlight for along time will do harm to one's skin.长时间的阳光照射会对皮肤造成伤害。 【参】harmless（adj.无害的）

- [ ] `wealth [welθ]`
    n.财富 【例】This country's wealth comes from its oil.这个国家的财富来自于它的石油。

- [ ] `else [els]`
    adj.别的，其他的 What else did you do?你还做了什么？

- [ ] `blow [bləʊ]`
    n.击，打击
    v.（blew, blown, blowing）吹（气）；刮风  【例】It was a great blow that he failed to pass the exam.考试不及格给他带来了沉重的打击。

- [ ] `messy [ˈmesi]`
    adj.乱七八糟的 【例】Jim's room was full of his son's messy toys.吉姆的房间乱七八糟的，到处是他儿子的玩具。
...
- [ ] `collar [ˈkɒlə]`
    n. 衣领 【例】a white-collar worker白领工作者

- [ ] `exchange [Iksˈtʃeɪndʒ]`
    n./v.交换；交流；兑换

- [ ] `interview [ˈɪntəvjuː]`
    n./v.采访；会见；面试 【参】interviewer（n.会见者；面试官）；interviewee（n.被访问者；面试者）

- [ ] `bunch [bʌntʃ]`
    n.串，束

- [ ] `outside [ˌaʊtˈsaɪd][ˈaʊtsaɪd]`
    n.外面，外表，外界 adv.在外面，向外面，出界 prep.在...外 adj.外面的，外表的 【例】On the outside, the house looked well cared for.从外面来看，房屋保护得很好。//It is cold outside.外面很冷。 【参】outsider（n.外人，局外人）

- [ ] `try [traI]`
    v.（tried, tried, trying）尝试，试图；努力

- [ ] `find [faɪnd]`
    vt.（found, found, finding）找到，发现；感到

- [ ] `space [speɪs]`
    n.空白处；空地；空间；太空 【例】Human beings must make good use of the space on the earth.人类必须合理利用地球上的空间。

- [ ] `invite [Inˈvaɪt]`
    vt.邀请；招待 【例】He wanted to invite us to dinner.他想邀请我们共进晚餐。 【参】invitation（n.邀请；请帖）；uninvited（adj.未被邀请的）

- [ ] `fan [fæn]`
    n.（电影、运动等的）迷，狂热的爱好者、支持者；风扇 【例】Thousands of fans flooded into the hall as the superstarappeared.当那位超级明星出现在大厅时，数千名粉丝如潮水般涌向那里。

- [ ] `score [skɔː]`
    n.[C]得分，分数；二十；许多，很多 v.得分 【例】There are still scores of boxes waiting to be checked.还有许多箱子没有检查。

- [ ] `fail [feɪl]`
    v.失败；不及格；衰退 【例】I failed my French test.我的法语考试没及格。//His eyesightis failing.他的视力正在衰退。

- [ ] `acute [əˈkjuːt]`
    adj.尖锐的；敏锐的；严重的；（疾病）急性的 【例】It is urgent that the acute problem of water pollution in the cityshould be dealt with.该城市水污染这一严重问题亟待解决。

- [ ] `sleepy [ˈsliːpi]`
    adj.想睡的，困倦的，瞌睡的 【例】On a summer day, the hot weather made Sara sleepy.夏季的一天，炎热的天气使萨拉昏昏欲睡。
...
- [ ] `downtown [ˈdaʊntaʊn]`
    n./adj.市区（的），闹市区（的） 【例】downtown Manhattan曼哈顿商业区

- [ ] `humour [ˈhjuːmə]`
    （美humor）n.幽默，幽默感 【例】He has a good sense of humour.他很有幽默感。

- [ ] `which [wɪtʃ]`
    pron.哪一个；哪一些

- [ ] `difference [ˈdɪfrəns]`
    n.不同 【例】There are a lot of differences between British English andAmerican English.英式英语和美式英语间有很多差异。

- [ ] `sense [sens]`
    n.感觉，意识

- [ ] `disagree [ˌdɪsəˈɡriː]`
    vi.意见不一致，持不同意见 【参】disagreement（n.意见不一致；争论）
...
- [ ] `guess [ɡes]`
    v.猜，猜测；认为 【例】Harry guessed he was the only one in his class who was stilllooking for a job.哈里猜他是班里唯一还在找工作的人。

- [ ] `sour [ˈsaʊə]`
    adj.酸的 【例】If you leave milk on the table for a long time, it will go sour.如果把牛奶长时间放在餐桌上，它会变酸的。

- [ ] `voyage [ˈvɔɪɪdʒ]`
    n.航行，航海，旅行 【例】They made a voyage to the distant island.他们航行去远方的小岛。
